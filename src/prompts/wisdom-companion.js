  ...
  if (styleExcerpts && styleExcerpts.trim()) {
    ...
    parts.push(
      `## MA framework and content (source material)\nThe following excerpts are Mastering Alchemy source material. ${toneNote}\n` +
        ...
        'Course example: That comes from [Core - Level 2](https://courses.masteringalchemy.com/courses/take/level-2-program/texts/63628124-welcome), Session 8 — Seven Layers of Thought - Extra Class. ' +
        'Wrong: putting Session/Lesson numbers or titles inside the link brackets (link text must be only the course/book name, e.g. Core - Level 2); reversing the course name order (never Level 2 — Core); wrapping track titles in quotation marks; repeating Session twice; using ACIMA instead of the full book name; swapping a book label onto a class URL; using https://masteringalchemy.com; or writing the raw URL as visible plain text. ' +
